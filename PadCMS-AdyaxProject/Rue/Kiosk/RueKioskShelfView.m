...
@interface RueKioskShelfView() <PCKioskAdvancedControlElementHeightDelegate>
...
@interface RueKioskShelfView() <UITableViewDelegate, UITableViewDataSource>
...
@implementation RueKioskShelfView
...
- (void) createCells
{
    ...
    for(int i = startRevisionIndex; i < startRevisionIndex + _numberOfRevisionsForCurrentpage; i++)
    {
        ...
        cell.revisionIndex = [(RueMainViewController*)self.dataSource indexForRevision:cell.revision];
